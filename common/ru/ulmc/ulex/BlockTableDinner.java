...
public class BlockTableDinner extends BlockContainer
{
	private Class anEntityClass;
	protected ItemTable itemDrop;
    public BlockTableDinner(int i, Class class1, float aHardness, float aResistance, String aBlockName)
    {
    ...
    {
    	TileEntityTableDinner tileEntityTableDinner = new TileEntityTableDinner();
    	tileEntityTableDinner.setType(itemDrop.getType());
        return tileEntityTableDinner;
    }
