...
public class BlockSkeletonChest extends BlockContainer
{
    private Random random = new Random();

    protected BlockSkeletonChest(int par1)
    {
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        TileEntitySkeletonChest var6 = (TileEntitySkeletonChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        TileEntitySkeletonChest var7 = (TileEntitySkeletonChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        Object var10 = (TileEntitySkeletonChest)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                var10 = new InventoryLargeChest("container.chestDouble", (TileEntitySkeletonChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)var10);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                var10 = new InventoryLargeChest("container.chestDouble", (IInventory)var10, (TileEntitySkeletonChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                var10 = new InventoryLargeChest("container.chestDouble", (TileEntitySkeletonChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)var10);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                var10 = new InventoryLargeChest("container.chestDouble", (IInventory)var10, (TileEntitySkeletonChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
