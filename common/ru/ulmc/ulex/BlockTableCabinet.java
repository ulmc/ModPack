...
public class BlockTableCabinet extends BlockContainer
{
	private Class anEntityClass;
	protected ItemTable itemDrop;
    public BlockTableCabinet(int i, Class class1, float aHardness, float aResistance, String aBlockName)
    {
    ...
    {
    	TileEntityTableCabinet tileEntityTableCabinet = new TileEntityTableCabinet();
    	tileEntityTableCabinet.setType(itemDrop.getType());
        return tileEntityTableCabinet;
    }
