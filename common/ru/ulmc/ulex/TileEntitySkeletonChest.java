...
public class TileEntitySkeletonChest extends TileEntity implements IInventory
{
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            if (this.worldObj.getBlockId(this.xCoord - 1, this.yCoord, this.zCoord) == UltimateExtender.blockSkeletonChest.blockID)
            {
                this.adjacentChestXNeg = (TileEntitySkeletonChest)this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.worldObj.getBlockId(this.xCoord + 1, this.yCoord, this.zCoord) == UltimateExtender.blockSkeletonChest.blockID)
            {
                this.adjacentChestXPos = (TileEntitySkeletonChest)this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord - 1) == UltimateExtender.blockSkeletonChest.blockID)
            {
                this.adjacentChestZNeg = (TileEntitySkeletonChest)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord + 1) == UltimateExtender.blockSkeletonChest.blockID)
            {
                this.adjacentChestZPosition = (TileEntitySkeletonChest)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    public void openChest()
    {
        ...
        this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, UltimateExtender.blockSkeletonChest.blockID, 1, this.numUsingPlayers);
    }
