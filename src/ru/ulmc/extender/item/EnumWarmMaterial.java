...
public enum EnumWarmMaterial {
	...
	COTTON("COTTON", 10, 10, new int[] { 0, 2, 1, 1 }, 5, 0.3f),
	APPAREL("APPAREL", 11, 20, new int[] { 2, 3, 1, 1 }, 9, 0.4f),
	FUR("FUR", 12, 20, new int[] { 1, 3, 2, 2 }, 10, 1.5f),
    IRONFUR("IRONFUR", 13, 15, new int[]{2, 6, 5, 2}, 9, 1.4f),
    DIAMONDFUR("DIAMONDFUR", 14, 33, new int[]{3, 8, 6, 3}, 10, 1.4f),
	HIDDEN("HIDDEN", 15, 10, new int[] { 0, 1, 1, 0 }, 5, 0.2f);
