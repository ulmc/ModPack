			...
			if (!this.worldObj.isRemote) {
				...
				if (this.onGround) {
					...
					if (this.worldObj.getBlockId(i, j, k) != Block.pistonMoving.blockID) {
						...
						if (this.worldObj.canPlaceEntityOnSide(this.blockID, i, j, k, true, 1, (Entity) null,
								(ItemStack) null)
							...
							this.entityDropItem(
									new ItemStack(this.blockID, 1, Block.blocksList[this.blockID]
											.damageDropped(this.metadata)), 0.0F);
						}
					}
