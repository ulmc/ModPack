...
public class BlockLockedChest extends BlockContainer implements UlmcBlock {
	...
	public BlockLockedChest(String aName) {
		super(Material.iron);
		setHardness(1.0F);
		...
		setBlockTextureName(Reference.RES_NAME + aName);
	...
	public int isProvidingWeakPower(IBlockAccess blockAccess, int x, int y, int z, int par5) {
		TileEntityLockedChest te = (TileEntityLockedChest) blockAccess.getTileEntity(x, y, z);
