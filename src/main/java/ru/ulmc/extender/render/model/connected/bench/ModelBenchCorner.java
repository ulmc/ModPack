 ...
 */
public class ModelBenchCorner extends ModelBase implements SimpleUlmcModel {
	...
	public ModelBenchCorner() {
		...
		leg2.setRotationPoint(2.5F, 15.5F, -1.5F);
		leg2.setTextureSize(128, 128);
		leg2.mirror = true;
		setRotation(leg2, 0F, -1.308997F, 0.2617994F);
		leg4 = new ModelRenderer(this, 18, 19);
		leg4.addBox(-1F, 0F, -1F, 2, 9, 2);
		leg4.setRotationPoint(-1.5F, 15.5F, 2.5F);
		leg4.setTextureSize(128, 128);
		leg4.mirror = true;
		setRotation(leg4, 0F, -0.2617994F, 0.2617994F);
		...
		support22.addBox(0F, 0F, 0F, 1, 10, 1);
		support22.setRotationPoint(2F, 21F, -2F);
