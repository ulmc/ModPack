 ...
 */
public class ModelBenchDoubleSided extends ModelBase implements SimpleUlmcModel {
	ModelRenderer sitting;
	ModelRenderer leg2;
	ModelRenderer leg4;
	ModelRenderer supproWide1;
	ModelRenderer support2;
	ModelRenderer support1;
	ModelRenderer overlay;

	public ModelBenchDoubleSided() {
		textureWidth = 128;
		textureHeight = 128;
		sitting = new ModelRenderer(this, 0, 62);
		sitting.addBox(-6F, -1F, -8F, 12, 2, 16);
		...
		leg2.setRotationPoint(0F, 15.5F, -1.5F);
		leg2.setTextureSize(128, 128);
		leg2.mirror = true;
		setRotation(leg2, 0F, -1.570796F, 0.2617994F);
		leg4 = new ModelRenderer(this, 18, 19);
		leg4.addBox(-1F, 0F, -1F, 2, 9, 2);
		leg4.setRotationPoint(0F, 15.5F, 1.5F);
		leg4.setTextureSize(128, 128);
		leg4.mirror = true;
		setRotation(leg4, 0F, 1.570796F, 0.2617994F);
		supproWide1 = new ModelRenderer(this, 0, 0);
		supproWide1.addBox(0F, 0F, 0F, 1, 4, 1);
		supproWide1.setRotationPoint(-0.5F, 21F, -2F);
		supproWide1.setTextureSize(128, 128);
		supproWide1.mirror = true;
		setRotation(supproWide1, 1.570796F, 0F, 0F);
		...
		overlay = new ModelRenderer(this, 42, 46);
		overlay.addBox(-8F, 0F, -5F, 16, 1, 10);
