 ...
 */
public class ModelTableOneSided extends ModelBase implements SimpleUlmcModel {
	ModelRenderer main;
	...
	public ModelTableOneSided() {
		...
		additional = new ModelRenderer(this, 3, 2);
		additional.addBox(-6.5F, 1F, -6.5F, 13, 1, 14);
