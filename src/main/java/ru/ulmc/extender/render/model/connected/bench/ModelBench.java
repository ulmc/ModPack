 ...
 */
public class ModelBench extends ModelBase implements SimpleUlmcModel {
	ModelRenderer sitting;
	ModelRenderer leg1;
	ModelRenderer leg2;
	ModelRenderer leg3;
	ModelRenderer leg4;
	ModelRenderer supportWide2;
	...
	public ModelBench() {
		...
		sitting = new ModelRenderer(this, 7, 0);
		sitting.addBox(-6F, -1F, -6F, 12, 2, 12);
		sitting.setRotationPoint(0F, 16F, 0F);
		sitting.setTextureSize(128, 128);
		sitting.mirror = true;
		setRotation(sitting, 0F, 1.570796F, 0F);
		leg1 = new ModelRenderer(this, 9, 19);
		leg1.addBox(-1F, 0F, -1F, 2, 9, 2);
		leg1.setRotationPoint(1.5F, 15.5F, 1.5F);
		...
		leg3 = new ModelRenderer(this, 27, 19);
		leg3.addBox(-1F, 0F, -1F, 2, 9, 2);
		leg3.setRotationPoint(1.5F, 15.5F, -1.5F);
		...
		supportWide2 = new ModelRenderer(this, 0, 0);
		supportWide2.addBox(0F, 0F, 0F, 1, 4, 1);
		supportWide2.setRotationPoint(2F, 21F, -2F);
		supportWide2.setTextureSize(128, 128);
		supportWide2.mirror = true;
		setRotation(supportWide2, 1.570796F, 0F, 0F);
		...
		support2.addBox(0F, 0F, 0F, 1, 4, 1);
