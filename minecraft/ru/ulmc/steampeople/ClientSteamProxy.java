...
public class ClientSteamProxy extends CommonSteamProxy
{
	@Override
    public void preInit()
    {
		MinecraftForgeClient.preloadTexture(SteamPref.TEXTURE_PATH_BLOCKS);
		MinecraftForgeClient.preloadTexture(SteamPref.TEXTURE_PATH_ITEMS);
		MinecraftForgeClient.preloadTexture(SteamPref.TEXTURE_PATH_ARMOR);
		MinecraftForgeClient.preloadTexture(SteamPref.TEXTURE_PATH_ARMOR_SKIN0);
		MinecraftForgeClient.preloadTexture(SteamPref.TEXTURE_PATH_ARMOR_SKIN1);
		MinecraftForgeClient.preloadTexture(SteamPref.TEXTURE_PATH_ARMOR_SKIN2);
		MinecraftForgeClient.preloadTexture(SteamPref.TEXTURE_PATH_ARMOR_SKIN3);
		MinecraftForgeClient.preloadTexture(SteamPref.TEXTURE_PATH_ARMOR_SKIN4);
		MinecraftForgeClient.preloadTexture(SteamPref.TEXTURE_PATH_ARMOR_SKIN5);
		MinecraftForgeClient.preloadTexture(SteamPref.TEXTURE_PATH_ARMOR_SKIN6);
		MinecraftForgeClient.preloadTexture(SteamPref.TEXTURE_PATH_ARMOR_SKIN7);
